...
const int SOILHUMIDITY_SENSOR_PIN = 36;
const int LOUDNESS_SENSOR_PIN = 35;
const int SD_PIN = 17;  //MIRAR
const int SOILTEMP_SENSOR_PIN = 13;    //MIRAR
