...
void handleNewMessages(int numNewMessages)
{
  ...
  for (int i = 0; i < numNewMessages; i++)
  {
    ...
    if (text == "/ringLoudness")
    {      
      ringElement = 6;
      bot.sendMessage(chat_id, "Ring show now the loudness", "");
    }
    ...
    {      
      displayMode = 2;
      fixedSensor = 6;
      bot.sendMessage(chat_id, "Display show now the loudness", "");
    }
    ...
    if (text == "/getLoudness")
    {
      String message="Ludness: "+(String)loudnessValue;
      bot.sendMessage(chat_id, message, "");
    }
    ...
    if (text == "/start")
    {
      ...
      welcome += "/ringLoudness : Show loudness value in the ring\n";
      ...
      welcome += "/getLoudness : actual loudness value\n";
      ...
      welcome += "/setLoudness : set loudness value in display\n";
